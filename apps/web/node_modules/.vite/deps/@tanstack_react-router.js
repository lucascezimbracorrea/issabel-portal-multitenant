...
import {
  require_react_dom
} from "./chunk-A2T7N3R4.js";
import {
  require_jsx_runtime
} from "./chunk-NEGHUYWX.js";
import {
  require_react
} from "./chunk-PF35UZKW.js";
import {
  __commonJS,
  __toESM
...
var useTags = () => {
  ...
  const links = useRouterState({
    select: (state) => {
      var _a2;
      const constructed = state.matches.map((match) => match.links).filter(Boolean).flat(1).map((link2) => ({
        tag: "link",
        attrs: {
          ...link2,
          nonce
